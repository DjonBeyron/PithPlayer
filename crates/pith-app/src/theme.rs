...
/// Закладка, которой приписан актёр.
///
/// Отрезок на полосе, название в панели и ножницы напротив него из жёлтых
/// становятся зелёными: подписанные закладки видно, не вчитываясь в список.
pub const ACTOR_MARK: Color32 = Color32::from_rgb(0x4A, 0xDE, 0x80);
